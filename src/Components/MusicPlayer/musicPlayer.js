...
const MusicPlayer = () => {
    return (
        <>
            <div className="musicPlayer flex flex-col px-5 w-[96%] mt-4 border-2 border-black py-3 bg-[#020917] rounded-xl">
                {/*upperPart*/}
                <div className={"upperPart flex items-center justify-between"}>
                    <div className={"profile flex items-center"}>
                        <img src={require("../../Assets/img/Mask Group 23.png")} alt=""
                             className="w-[2.5rem] h-[2.5rem] border-2 border-white rounded-full"
                        />
                        <div className="details flex flex-col gap-2 ml-4">
                            <span className={"text-xl"}>mehrad hidden</span>
                            <span className={"text-gray-500 text-sm"}> Kaj from zozenaghe</span>
                        </div>
                    </div>
                    <img src={require('../../Assets/img/path.png')} alt="" className={"h-[1rem]"}/>
                </div>
                {/*lower part*/}
                <div className={"lowerPart flex items-center justify-between mt-5"}>
                    <div className="track flex justify-between text-sm text-gray-500 flex-[2] items-center">
                        <span>2:30</span>
                        <img src={require('../../Assets/img/Group 9.png')} alt="" className={"w-[16rem]"}/>
                        <span>5:30</span>
                    </div>
                    {/* Controls */}
                    <div className="controls flex-1 flex items-center justify-around">
                        ...
                        {/* pauseButton */}
                        <div className="pauseButton flex items-center relative animate animate-pulse decoration-4 ">
                            {/* cicrle */}
